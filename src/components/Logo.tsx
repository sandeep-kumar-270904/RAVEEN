export function Logo({ className = '' }: { className?: string }) {
  return (
    <div className={`flex items-center gap-2 font-mono font-bold tracking-wider ${className}`}>
      <div className="relative flex h-8 w-8 items-center justify-center rounded bg-raven-bg-surface border border-raven-border-subtle shadow-[0_0_15px_rgba(61,220,151,0.15)]">
      ...
      <span className="text-raven-text-primary text-lg">
